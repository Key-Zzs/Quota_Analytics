class AppConstants {
  ...
  static const appMode = 'stage8_1-reload-before-refresh';
  static const stageNotice =
      'Stage 8.1: reload-before-refresh is foreground-only. Background checks remain notify-only unless a future background-safe data source exists. No background WebView, cookie, token, storage, HTML, or page text access.';
